...
var app = (function () {
    ...
    class SelectableIcon extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { selectable: 0 });
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(ul, "class", "selectables-used");
    			add_location(ul, file$1, 23, 4, 861);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(23:0) {#if usedSelectables}",
    		ctx
    	});
    ...
    // (25:8) {#each usedSelectables as item (item.key)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t = space();
    			add_location(li, file$1, 25, 8, 952);
    			this.first = li;
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*usedSelectables*/ 1) selectableicon_changes.selectable = /*item*/ ctx[6];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(25:8) {#each usedSelectables as item (item.key)}",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$1, 32, 4, 1074);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    			append_dev(span, t);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(strong, "class", "time");
    			add_location(strong, file$1, 21, 4, 796);
    			attr_dev(div, "class", "single-entry");
    			add_location(div, file$1, 20, 0, 764);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class SingleEntry_1 extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    // (18:8) {#each entries as entry (entry.id)}
    function create_each_block$1(key_1, ctx) {
    	let li;
    	let t;
    	let current;

    	const singleentry = new SingleEntry_1({
    			props: {
    				entry: /*entry*/ ctx[4],
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t = space();
    			add_location(li, file$2, 18, 8, 474);
    			this.first = li;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, li, anchor);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*entries*/ 4) singleentry_changes.entry = /*entry*/ ctx[4];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(18:8) {#each entries as entry (entry.id)}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(strong, file$2, 15, 9, 374);
    			add_location(div0, file$2, 15, 4, 369);
    			add_location(ol, file$2, 16, 4, 415);
    			add_location(div1, file$2, 14, 0, 358);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	return [headerText, selectableMap, entries, date];
    }
    ...
    // (64:4) {#each selectables as item (item.key)}
    function create_each_block_1(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(input, file$3, 65, 5, 1880);
    			attr_dev(label, "class", "selectable-target");
    			add_location(label, file$3, 64, 4, 1841);
    			this.first = label;
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(64:4) {#each selectables as item (item.key)}",
    		ctx
    	});
    ...
    // (83:3) {#each latestEntriesByDate as group (group.id)}
    function create_each_block$2(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t = space();
    			add_location(li, file$3, 83, 3, 2345);
    			this.first = li;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, li, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(83:3) {#each latestEntriesByDate as group (group.id)}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$3, 62, 3, 1768);
    			attr_dev(textarea, "id", "note");
    			attr_dev(textarea, "name", "note");
    			add_location(textarea, file$3, 73, 4, 2082);
    			attr_dev(label, "class", "note");
    			add_location(label, file$3, 71, 3, 2047);
    			attr_dev(button, "type", "button");
    			add_location(button, file$3, 76, 4, 2169);
    			add_location(div1, file$3, 75, 3, 2159);
    			attr_dev(form, "name", "updog");
    			attr_dev(form, "method", "post");
    			add_location(form, file$3, 61, 2, 1731);
    			attr_dev(section0, "id", "log-form");
    			add_location(section0, file$3, 60, 4, 1705);
    			add_location(ol, file$3, 81, 2, 2286);
    			attr_dev(section1, "id", "history");
    			add_location(section1, file$3, 80, 1, 2261);
    			attr_dev(main, "class", "svelte-1tky8bj");
    			add_location(main, file$3, 59, 0, 1694);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
